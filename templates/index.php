...
<html lang="en">
  <head>
    <title>Premedic-Pneumonia Chest Analysis</title>
    <meta charset="utf-8">
...
<?php $_COOKIE['Name'];?>
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    ...
    <div class="hero-wrap" style="background-image: url('{{ url_for('static', filename='images/pneumonia.jpg') }}'); background-attachment:fixed;">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h3 class="mb-3 bread">Pneumonia-Department</h3>
          </div>
        </div>
      </div>
    </div>
   ...
   <section class="ftco-section contact-section ftco-degree-bg" style="height: 800px">
      ...
      <div class="container col-lg-6" >
            ...
            <div class="w3-card-4" style="width: 700px; height: 500px; ">
              <div class="w3-container w3-black">
                <h2 style="color:white;">Pneumonia Chest Analysis</h2>
              </div>
